...
#%%
submission_file = (
    "answer.json"  # this file contains output of branchLSTM model for Tasks A and B
)
submission_fileB = "../NileTMRG_baseline/answerB.json"
reference_file = "../data/test/final-eval-key.json"
...
print(
    "Precision, recall, fscore, support per class \n",
    precision_recall_fscore_support(
        true, pred, labels=["support", "comment", "deny", "query"]
    ),
)
...
#%%
# BUG :: yhat, confidence = task_results[k] -- KeyError: '443938194715713536'
task = "subtaskbenglish"
